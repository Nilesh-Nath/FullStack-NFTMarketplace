...
export class CancelNftCall extends ethereum.Call {
  get inputs(): CancelNftCall__Inputs {
    return new CancelNftCall__Inputs(this);
  }

  get outputs(): CancelNftCall__Outputs {
    return new CancelNftCall__Outputs(this);
  }
}

export class CancelNftCall__Inputs {
  _call: CancelNftCall;

  constructor(call: CancelNftCall) {
    this._call = call;
  }
...
export class CancelNftCall__Outputs {
  _call: CancelNftCall;
